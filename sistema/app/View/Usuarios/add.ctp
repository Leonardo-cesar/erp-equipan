<div class="niveis form">
    ...
    <fieldset>
        ...
        <div class="form-group col-sm-12" style="margin-left: 0" id="setor">
        ...
        <div class="form-group col-sm-12">
            <?php echo $this->Form->input('senha', array('label' => 'Senha', 'div' => 'col-sm-4', 'class' => 'form-control', 'type' => 'password')); ?>
        </div>
        <div class="form-group col-sm-12">
