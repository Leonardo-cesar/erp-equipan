<div class="pedidos form">
    <fieldset>
        <legend>Entregar Em Lote</legend>
        ...
        <div class="form-group col-sm-12">
            <a href="javascript:;" class="btn btn-success" id="pesquisarEntregaLote"><i class="glyphicon glyphicon-search"></i> Pesquisar</a>
        </div>
        <div id="entrega" style="display: none">
            ...
            <div id="concluir" >
                ...
                <a href="javascript:;" class="btn btn-success" id="baixarEntregaLote"><i class="glyphicon glyphicon-road"></i> Concluir Entrega</a>
            </div>
