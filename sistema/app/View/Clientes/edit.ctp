<div class="niveis form">
    <fieldset>
        ...
        <br clear="all"/>
        <hr />
        <?php $style = $this->request->data['Cliente']['cliente_id'] != '' ? 'display: none;' : ''; ?>
        <?php echo $this->Form->create('Cliente', array("class" => "form-horizontal form-cliente", 'id' => 'validate', 'type' => 'file', 'style' => $style)); ?>
        ...
        <div class="pj" <?php echo $this->request->data['Cliente']['cnpj'] == '' ? 'style="display: none;"' : '' ?>>
            <br clear="all"/>
            <hr />
            <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-4">
                <?php echo $this->Form->input('cpf_responsavel', array('type' => 'text', 'label' => 'CPF Responsavel', 'div' => 'col-sm-12', 'class' => 'cpf_r form-control')); ?>
            </div>
            <div class="form-group col-sm-6">
        ...
        <div class="pf" <?php echo $this->request->data['Cliente']['cpf'] == '' ? 'style="display: none;"' : '' ?>>
            <br clear="all"/>
            <hr />
            <div class="form-group col-sm-4">
        ...
        <hr />
        <div class="form-group col-sm-12">
            <?php echo $this->Form->input('prazo', array($this->request->data['Cliente']['prazo'] == '' ? 'disabled' : '', 'label' => 'Liberar compra  por crédito', 'checked' => 'checked', 'div' => 'checkbox col-sm-4')); ?>
        </div>
        <div class="form-group col-sm-12">
            <?php if ($this->request->data['Cliente']['prazo'] == '') { ?><?php echo $this->Html->link('<i class="glyphicon glyphicon-asterisk"></i> ' . 'Informar senha para liberação', 'javascritp:;', array('style' => 'margin-left: 15px;', 'class' => 'alert alert-info', 'id' => 'liberar', 'data-toggle' => "modal", 'data-target' => ".bs-example-modal-sm", 'escape' => FALSE)) ?><?php } ?>
        ...
        <div class="form-group col-sm-4">
            ...
            <?php echo $this->request->data['Cliente']['arquivo1'] != '' ? '<span style="color:red">Anexo 1</span>: '.$this->Html->link($this->request->data['Cliente']['arquivo1'], '/files/docs/' . $this->request->data['Cliente']['arquivo1'], array('target' => '_blank')) : ''; ?>
        </div>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->file('arquivo2'); ?>
            <?php echo $this->request->data['Cliente']['arquivo2'] != '' ? '<span style="color:red">Anexo 2</span>: '.$this->Html->link($this->request->data['Cliente']['arquivo2'], '/files/docs/' . $this->request->data['Cliente']['arquivo2'], array('target' => '_blank')) : ''; ?>
        </div>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->file('arquivo3'); ?>
            <?php echo $this->request->data['Cliente']['arquivo3'] != '' ? '<span style="color:red">Anexo 3</span>: '.$this->Html->link($this->request->data['Cliente']['arquivo3'], '/files/docs/' . $this->request->data['Cliente']['arquivo3'], array('target' => '_blank')) : ''; ?>
        </div>
        <br clear="all"/>
        <hr />
        <div class="form-group col-sm-12">
        ...
        <?php $style = $this->request->data['Cliente']['cliente_id'] == '' ? 'display: none;' : ''; ?>
        <?php echo $this->Form->create('Cliente', array("class" => "form-horizontal form-representante", 'id' => 'validate', 'type' => 'file', 'style' => $style)); ?>
        <?php echo $this->Form->input('id'); ?>
        <div class="form-group col-sm-12">
