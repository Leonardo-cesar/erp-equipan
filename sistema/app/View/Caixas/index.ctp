<div class="pedidos form">
    <fieldset>
        ...
        <div class="alert alert-success" role="alert" style="display: none;"><i class="glyphicon glyphicon-ok-sign"></i> Baixa concluída com sucesso!</div>
        ...
        <div class="form-group col-sm-12">
            <a href="javascript:;" class="btn btn-success" id="pesquisarCaixa"><i class="glyphicon glyphicon-search"></i> Pesquisar</a>
        </div>
        <br clear="all" />
        <p class="pedidoPago bg-danger" style="display: none"></p>
        <div id="caixa" style="display: none">
            <br clear="all" />
            <hr />
            <?php echo $this->Form->create('Caixa', array("class" => "form-horizontal")); ?>
            ...
            <div class="form-group col-sm-12">
                <table class="table table-bordered table-hover table-striped tpedido" id="tableKit" style="margin-bottom: 0px">
                    ...
                    <div class="desconto">Desconto: <span class="sdesconto">R$ <?php echo $this->Form->input('desconto', array('readonly', 'type' => 'text', 'label' => false, 'div' => false, 'style' => 'display: inline;width: 40%!important;')); ?></span></div><br />
                    <div class="td">Total com Desconto: <span class="std">R$ <?php echo $this->Form->input('valorTotal', array('readonly', 'type' => 'text', 'label' => false, 'div' => false, 'style' => 'display: inline;width: 40%!important;')); ?></span></div>
                    </th>
                    </tr>
                    </tfoot>
                </table>
            ...
            <hr />
            <div class="form-group col-sm-12">
                <?php echo $this->Form->input('desconto', array('div' => 'col-sm-4', 'label' => 'Desconto', 'class' => 'maskMoney form-control')); ?>
            </div>
            <div class="form-group col-sm-12">
            ...
            <?php echo $this->Form->input('parcial', array('type' => 'hidden', 'valeu' => 1, 'label' => false, 'div' => false)); ?>
