<div class="pedidos form">
    <fieldset>
        ...
        <div id="entrega">
            <?php echo $this->Form->create('Pedidosexcluido', array("class" => "form-horizontal")); ?>
            <div class="col-sm-12" style=" text-align: center;">
                <span class="col-sm-12" style="font-size: 20px;font-weight: bold;">Você tem certeza que deseja excluir o Pedido?</span>
            ...
            <div id="concluir" >
                ...
                <button type="submit" class="btn btn-danger"><i class="glyphicon glyphicon-ok"></i> Confirmar exclusão</button>
            </div>
