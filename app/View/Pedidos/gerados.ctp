<div class="pedidos form">
    <fieldset>
        <legend>Relatorio de Pedidos Gerados</legend>
        ...
        <div class="form-group col-sm-4">
            <?php echo $this->Form->input('cliente_id', array('type' => 'select', 'empty' => ' - Selecione - ', 'div' => 'col-sm-12', 'class' => 'form-control')); ?>
        </div>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->input('categoria_id', array('empty' => ' - Selecione - ', 'div' => 'col-sm-12', 'class' => 'form-control')); ?>
        </div>
        <br clear="all"/>
        <button type="submit" class="btn btn-success" id="gerarGerados"><i class="glyphicon glyphicon-refresh"></i> Gerar</button>
        <br clear="all"/>
        <?php echo $this->Form->end(); ?>
        <div class="divGE form-group col-sm-12" style="display: none">
            <br clear="all"/>
            <hr />
            <br clear="all"/>
            ...
            <?php echo $this->Html->link('<i class="glyphicon glyphicon glyphicon-download-alt"></i> Excel', '/pedidos/geradosExcel/', array('escape' => false, 'class' => 'btn btn-info', 'target' => '_blank')) ?>
            <br />
            <br />
            <table class="TableJquery" id="tablePedidosGerados">
                <thead>
                    <tr>
                        <th>N°</th>
                        <th>Produtos</th>
