<div class="pedidos form confirmar">
    ...
    <fieldset>
        ...
        <div class="cliente">
            ...
            <br clear="all" />
            <hr />
            <label class="tipo">Tipo de Pagamento</label>
            ...
            <br clear="all" />
            <label class="tipo">Pedido</label>
            <div><?php echo isset($this->request->data['Pedido']['pendente']) ? '<p class="bg-danger aprazo col-sm-2">Pendente</p>' : '<p class="bg-success avista col-sm-2">Concluido</p>' ?></div>
            <br clear="all" />
            <hr />
            ...
            <div class="form-group col-sm-12">
                <div class="col-sm-12 alert alert-warning" style="min-height: 52px;border: 1px #9e9200 solid!important;">
                    <i class="glyphicon glyphicon-warning-sign" style="float: left;padding: 2px 10px 0 0;"></i><input type="checkbox" value="1" id="cAtender" style="float: left"/><strong style="float: left;padding-left: 5px;">Analisado criticamente ?</strong>
                </div>
            </div>
            ...
            <?php echo $this->Form->input('pendente', array('type' => 'hidden', 'label' => false, 'div' => false)); ?>
            <?php echo $this->Form->input('valor', array('value' => $this->request->data['Pedido']['Vtotal'], 'type' => 'hidden', 'label' => false, 'div' => false)); ?>
            <button id="bConfirmar2" class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Confirmar Pedido</button>
