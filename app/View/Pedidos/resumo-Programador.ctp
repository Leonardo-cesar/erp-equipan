<div class="pedidos form">
    <fieldset>
        ...
        <div class="form-group col-sm-2">
            <?php echo $this->Form->input('pendente', array('empty' => ' - Todos - ', 'options' => array(0 => 'Concluido', 1 => 'Pendente', '3' => 'Todos'), 'div' => 'col-sm-12', 'class' => 'form-control', 'label' => 'Situação do Pedido')); ?>
        </div>
        <div class="form-group col-sm-2">
