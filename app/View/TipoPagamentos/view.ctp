...
<h2><?php echo __('Tipo Pagamento'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($tipoPagamento['TipoPagamento']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Nome'); ?></dt>
		<dd>
			<?php echo h($tipoPagamento['TipoPagamento']['nome']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Ativo'); ?></dt>
		<dd>
			<?php echo h($tipoPagamento['TipoPagamento']['ativo']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($tipoPagamento['TipoPagamento']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($tipoPagamento['TipoPagamento']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Tipo Pagamento'), array('action' => 'edit', $tipoPagamento['TipoPagamento']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Tipo Pagamento'), array('action' => 'delete', $tipoPagamento['TipoPagamento']['id']), array(), __('Are you sure you want to delete # %s?', $tipoPagamento['TipoPagamento']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Tipo Pagamentos'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Tipo Pagamento'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($tipoPagamento['Lancamento'])): ?>
	...
	<?php foreach ($tipoPagamento['Lancamento'] as $lancamento): ?>
		<tr>
...
<div class="related">
	...
	<?php if (!empty($tipoPagamento['Unidade'])): ?>
	<table cellpadding = "0" cellspacing = "0">
	<tr>
		<th><?php echo __('Id'); ?></th>
	...
	<?php foreach ($tipoPagamento['Unidade'] as $unidade): ?>
		<tr>
