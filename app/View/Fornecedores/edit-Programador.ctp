<div class="niveis form">
    <fieldset>
        ...
        <br clear="all"/>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->input('observacao', array('type' => 'textarea', 'label' => 'Observação', 'div' => 'col-sm-12', 'class' => 'form-control')); ?>
        </div>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->input('ativo', array('type' => 'select', 'label' => 'Situação', 'options' => array('0' => 'Desativado', '1' => 'Ativado'), 'div' => 'col-sm-12', 'class' => 'form-control')); ?>
        </div>
        <br clear="all"/>
        <hr />
