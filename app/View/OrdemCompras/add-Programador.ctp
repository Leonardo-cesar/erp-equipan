    ...
    <fieldset>
        ...
        <div class="cliente">
            ...
            <div class="form-group col-sm-2">
                <?php echo $this->Form->input('Oquantidade', array('type' => 'text', 'label' => 'Quantidade', 'div' => 'col-sm-12', 'class' => 'form-control', 'style' => 'text-transform:uppercase')); ?>
            </div>
            <div class="form-group col-sm-2">
                <?php echo $this->Form->input('Ovalor', array('type' => 'text', 'label' => 'Valor', 'div' => 'col-sm-12', 'class' => 'maskMoney form-control')); ?>
            </div>
