                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li class="dropdown-submenu">
                                <?php echo $this->Html->link('Ordem de Compras', '#') ?>
                                <ul class="dropdown-menu">
                                    <li><?php echo $this->Html->link('Cadastrar Fornecedor', '/fornecedores') ?></li>
                                    <li><?php echo $this->Html->link('Cadastro de Produto', '/ocProdutos') ?></li>
                                    <li><?php echo $this->Html->link('Gerar Ordem de Compra', '/ordemCompras') ?></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
