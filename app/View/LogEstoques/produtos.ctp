<div class="pedidos form">
    <fieldset>
        <legend>Relatorio de Produtos</legend>
        ...
        <br clear="all"/>
        <button type="submit" class="btn btn-success" id="gerarProduto"><i class="glyphicon glyphicon-refresh"></i> Gerar</button>
        <br clear="all"/>
        ...
        <div class="divPR form-group col-sm-12" style="display: none">
            ...
            <hr />
            <br clear="all"/>
            <?php echo $this->Html->link('<i class="glyphicon glyphicon-print"></i> Imprimir', '/LogEstoques/pimprimir/', array('escape' => false, 'class' => 'btn btn-primary', 'target' => '_blank')) ?>
            <?php echo $this->Html->link('<i class="glyphicon glyphicon glyphicon-download-alt"></i> Excel', '/LogEstoques/excelProdutos/', array('escape' => false, 'class' => 'btn btn-info', 'target' => '_blank')) ?>
            <br />
            <br />
