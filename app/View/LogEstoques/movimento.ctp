<div class="pedidos form">
    <fieldset>
        <legend>Relatorio de Movimento de Estoque</legend>
        ...
        <br clear="all"/>
        <div class="form-group col-sm-4">
            <?php echo $this->Form->input('tipo', array('type' => 'select', 'empty' => ' - Todos -', 'options' => array(0 => 'Adição', 1 => 'Baixa', 2 => 'Transferencia'), 'div' => 'col-sm-12', 'label' => 'Tipo', 'class' => 'form-control')); ?>
        </div>
        <div class="form-group col-sm-4">
        ...
        <br clear="all"/>
        <button type="submit" class="btn btn-success" id="gerarMovimento"><i class="glyphicon glyphicon-refresh"></i> Gerar</button>
        <br clear="all"/>
