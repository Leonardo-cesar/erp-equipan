...
<?php echo $this->Form->create('Caixa'); ?>
	...
	<?php
		...
		echo $this->Form->input('formas_pagamento_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Caixa.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Caixa.id'))); ?></li>
